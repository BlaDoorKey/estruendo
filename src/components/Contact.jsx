      ...
      <div className="container mx-auto text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4 mb-16">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center px-6 py-3 border-2 rounded-md bg-yellow-700 text-white hover:bg-yellow-800 transition duration-300">
            <img
              src="logomail.png"
              alt="Gmail"
              className="w-8 h-8 mr-2"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center px-6 py-3 border-2 rounded-md bg-fuchsia-700 text-white hover:bg-fuchsia-800 transition duration-300">
            <img
              src="logoig.png"
              alt="Gmail"
              className="w-8 h-8 mr-2"
        ...
        <div className="w-full relative">
          <p className="text-white text-4xl text-center underline">
            Av. Graciano Sánchez 7, Primero de Mayo Sur, Boca del Río, Ver. México
          </p>
          <div className="w-full h-0 relative overflow-hidden pb-56 border border-red-600 rounded-md mb-6">
            <iframe
